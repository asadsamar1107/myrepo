...
<div className="px-6 w-full ">
            ...
            <div className={`${sidebarStyle}`}>
              ...
              <div className="px-[19px] gap-1">
                ...
                <div className={`${sidebarStyle} `}>
                    <h1 className="pt-0.5 font-semibold text-base text-gray-700">Home</h1>
                </div>
          ...
          <div className={`${sidebarStyle} flex flex-row  gap-3`}>
            <div className={`${sidebarStyle} flex flex-row pl-2 gap-3`}>
                ...
                <div className={`${sidebarStyle} flex flex-col`}>
                   <p className="not-italic font-semibold text-sm text-gray-700">Olivia Rhye</p>
  
                   <p className="not-italic font-normal text-sm text-gray-600">olivia@untitledui.com</p>
